...
# Inspect T_snapshots
t_snapshots_path = os.path.join(rom_dir, 'rom_T_snapshots.npy')
...
# Inspect Tsupply_snapshots
tsupply_snapshots_path = os.path.join(rom_dir, 'rom_tsupply_snapshots.npy')
...
if os.path.exists(tsupply_snapshots_path):
    try:
        ...
        print(f"Shape of Tsupply_snapshots: {tsupply_snapshots.shape}") # Expected (N_s,) or (N_s, 1) or (1, N_s)

        # Ensure tsupply_snapshots is 1D for easier processing, regardless of original saved shape
...
q_loss_pipe_snapshots_path = os.path.join(rom_dir, 'rom_q_loss_pipe_snapshots.npy')
